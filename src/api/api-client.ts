 ...
 */
// biome-ignore lint/correctness/noUnusedVariables: This exported helper is consumed by app code.
export async function sendRequest(
    ...
    const fetchPromise: Promise<unknown> = (async () => {
        try {
            ...
            console.error(`[API-CLIENT] Request failed: ${method.toUpperCase()} ${url} - ${error.message}`);
            return Promise.reject(err);
        } finally {
